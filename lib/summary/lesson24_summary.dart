const String lesson24Summary = '''
Bu derste Flutter'da tema özelleştirmeleri ve farklı buton yapılandırmaları anlatılmaktadır. 
...
- ThemeData: Uygulamanın genel temasını belirlemek için kullanılmıştır.
  ...
  - TextTheme: Metinlerin varsayılan rengi siyah olarak değiştirilmiştir.
...
- Scaffold: Sayfanın temel yapısı oluşturulmuştur.
  ...
  - Body (Column içinde):
    - Text widget’ları ile metinler gösterilmiştir.
